...
@Entity(tableName = CourseChanges.TABLE_NAME)
@Serializable
data class CourseChanges(
    @PrimaryKey @ColumnInfo(name = "id") @SerialName("id") val id: String,
    @ColumnInfo(name = "course_id") @SerialName("course_id") val courseId: String? = null,
    ...
    companion object {
        const val TABLE_NAME = "course_changes"
    }
